...
export function PropertyCardWithPrice(props: {
  ...
  return (
    <div className="relative z-10">
      {props.aiRecommended && (
        <div className="absolute -top-2 -right-2 z-20 rounded-full bg-gradient-to-r from-purple-500 to-fuchsia-500 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wide text-white shadow-lg shadow-brand">
          EstateX pick
        </div>
      )}
      <PropertyCard
