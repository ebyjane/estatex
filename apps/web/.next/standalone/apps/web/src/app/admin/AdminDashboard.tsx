    ...
    return (
      <div className="mx-auto max-w-lg px-6 py-20 text-center">
        ...
        <p className="mt-3 text-sm text-slate-400">
          ...
          <code className="text-cyan-400">admin@estatex.ai</code> /{' '}
    ...
    return (
      <div className="mx-auto max-w-lg px-6 py-20 text-center">
        ...
        <p className="mt-3 text-sm text-slate-400">
          ...
          in as <code className="text-cyan-400">admin@estatex.ai</code> (seed password{' '}
      ...
      <div className="flex flex-col gap-4 border-b border-white/10 pb-6 md:flex-row md:items-end md:justify-between">
        <div>
          <div className="flex flex-wrap items-center gap-3">
            <h1 className="text-2xl font-bold text-white md:text-3xl">EstateX Control Panel</h1>
            <span className="rounded-full border border-purple-500/40 bg-purple-500/15 px-2.5 py-0.5 text-xs font-semibold uppercase tracking-wide text-purple-300">
              AI Powered
            </span>
          </div>
        ...
        <Link
          href="/post-property"
          className="inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-cyan-400 to-blue-500 px-4 py-2.5 text-sm font-medium text-slate-950 shadow-brand transition-all hover:scale-105"
        >
