    ...
    <div className="relative z-20 mt-6 flex flex-col gap-3">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
        ...
        <button
          ...
          onClick={() => void submit()}
          disabled={busy}
          className="inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-violet-600 to-fuchsia-600 px-5 py-3 text-sm font-medium text-white shadow-lg shadow-violet-500/20 hover:opacity-95 disabled:opacity-50"
        >
          <Search className="h-4 w-4" />
          {busy ? 'Searching…' : 'AI Search'}
        </button>
      </div>
