...
export function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 border-b border-slate-800/50 dark:border-slate-800/50 border-slate-200 bg-white/80 dark:bg-slate-950/80 backdrop-blur-md">
